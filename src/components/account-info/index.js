...
function AccountInfo({ profileInfo }) {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="flex items-baseline justify-between pb-6 border-b dark:border-white border-cyan-500 pt-24">
        <h1 className="text-4xl font-semibold tracking-tight dark:text-white text-cyan-900">
          Account Details
        </h1>
      </div>
