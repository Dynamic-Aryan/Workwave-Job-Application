    ...
    <div>
      <div className="mx-auto max-w-7xl">
        <div className="flex items-baseline dark:border-white justify-between border-b border-cyan-500 pb-6 pt-24">
          <h1 className="text-4xl dark:text-white font-bold tracking-tight text-cyan-900 hover:text-zinc-800">
        ...
        <div className="pt-6 pb-24">
          <div className="grid grid-cols-1 gap-x-9 gap-y-11 lg:grid-cols-3">
