  ...
  return (
    <div className="mx-auto max-w-7xl">
      <Tabs defaultValue="Applied" className="w-full">
        <div className="flex items-baseline justify-between border-b dark:border-white border-cyan-500 pb-6 pt-24">
          <h1 className="text-4xl font-bold tracking-tight dark:text-white text-cyan-900 hover:text-zinc-800">
            Your Activity...
          </h1>
          <TabsList>
