...
const stripePromise = loadStripe(
  "pk_test_51PbeidK3tWKjvi0A05VrsEHh5amXR5evAH56Q2y1mkzoYupqqZMxYxIMbuGiqrIJpI6OOGcQaeFCMJkPpU4QwjF900B45pnI49"
);
...
function Membership({ profileInfo }) {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="flex items-baseline dark:border-white justify-between border-b border-cyan-500 pb-6 pt-24">
        <h1 className="text-4xl font-bold dark:text-white tracking-tight text-cyan-900">
                ...
                footerContent={
                  ...
                  index < 2 ? null : (
                    <Button
                      ...
                      className="disabled:opacity-60 dark:bg-[#94a3b8] flex h-11 items-center justify-center px-5"
                    >
